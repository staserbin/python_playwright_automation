...
from constants.errors import ELEMENT_ERROR
...
class HomePage:
    ...
    def is_carousel_visible(self):
        expect(self.page.locator(".carousel-inner").first, ELEMENT_ERROR).to_be_visible()

    @allure.step("Check that the Features Items title is present")
    def has_features_title(self):
        (expect(self.page.locator("div.features_items h2[class*='title']"), ELEMENT_ERROR)
            .to_contain_text("Features Items"))